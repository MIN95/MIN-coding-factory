	...
	$("#apply_btn").click(function(){
      ...
      if(my_name!=""){
    	  if(name==""){
              ...
              if($("#tel").val().length<11||$("#tel").val().length>13){
            	  $("form").submit(function(e){
          			$("#tel_div>span").remove();   
          			$("#tel_div").append("<span>번호를 다시 입력해주세요</span>");
                      e.preventDefault(e);
                  });
              }else{
            	  $("#tel_div>span").remove();
    	...
    	if(user_apply==""){
    		$("form").submit(function(e){
    			...
    			$("#file_upload").append("<span>파일을 업로드해주세요</span>");
                e.preventDefault(e);
            });
    	}else{
    		$("#file_upload>span").remove();
    	...
    	if(agree!=true){
    		$("form").submit(function(e){
    			...
    			$("#agree_div").append("<span>약관에 동의해주세요</span>");
                e.preventDefault(e);
            });
    	}else{
    		$("#agree_div>span").remove(); 
